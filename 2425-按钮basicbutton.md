...
| emphasis | Object | √ |  |  | 按钮**选中**状态样式 |
| emphasis.backgroundColor | String | √ | \#31b16c | 支持CSS3中颜色的参数值，包括Color Name\(颜色名称\)、HEX、RGB、RGBA、HSL、HSLA、transparent | 按钮**选中**状态背景颜色 |
| emphasis.fontSize | String | √ | 20px | 支持CSS3中font-size的参数值 | 按钮**选中**状态文本大小 |
| emphasis.borderRadius | String | √ | 5px | 支持CSS3中border-radius的参数值 | 按钮**选中**状态边框圆角角度 |
| emphasis.border | String | √ | 1px solid \#31b16c | 支持CSS3中border的参数值 | 按钮**选中**状态边框样式 |
| emphasis.color | String | √ | \#fff | 支持CSS3中颜色的参数值，包括Color Name\(颜色名称\)、HEX、RGB、RGBA、HSL、HSLA、transparent | 按钮**选中**状态文本颜色 |
| emphasis.lineHeight | String | √ | 30px | 支持CSS3中line-height的参数值 | 按钮**选中**状态文本的行间距 |
