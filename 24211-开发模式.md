...
<tr>
	<th>配置项</th>
	<th width="60%">功能/描述</th>
	<th>可选参数</th>
</tr>
<tr>
	<td align="center">currentSelect | Number</td>
	<td>初始化进入导航栏时默认的当前选中项</td>
	<td></td>
</tr>
<tr>
	<td align="center">automatic | Object</td>
	<td>自动切换导航栏，有start和interval两个属性</td>
	<td></td>
</tr>
<tr>
	<td align="center">automatic.start | Bool</td>
	<td>是否自动切换导航栏</td>
	<td></td>
</tr>
<tr>
	<td align="center">automatic.interval | Number</td>
	<td>切换导航项的时间间隔，单位为毫秒。该属性当且仅当start为true时有效</td>
	<td></td>
</tr>
<tr>
	<td align="center">maxNumInOneLine | Number</td>
	<td>导航栏中每行可以显示最多的导航项数目</td>
	<td></td>
</tr>
<tr>
	<td align="center">series | Array[Object]</td>
	<td>数据及样式的系列配置</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].type | String</td>
	<td>控件类型——withTriangleNav导航栏，不可修改</td>
	<td align="center">withTriangle</td>
</tr>
<tr>
	<td align="center">series[0].data | Array[Object]</td>
	<td>导航控件中的数据项</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].data[0].key | String</td>
	<td>导航项数据的唯一标识，不可重复</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].data[0].name | String</td>
	<td>导航项显示的文本数据信息，允许重复</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].textStyle | Object</td>
	<td>导航项的文本样式，有normal和emphasis两个属性</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].textStyle.normal | Object</td>
...
<tr>
	<td align="center">series[0].textStyle.emphasis | Object</td>
...
<tr>
	<td align="center">series[0].borderStyle | Object</td>
	<td>导航项的边框样式，仅有normal一个属性</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].borderStyle.normal | Object</td>
	<td>导航项边框样式</td>
	<td><pre> {
...
<tr>
	<td align="center">series[0].backgroundStyle | Object</td>
	<td>导航项的背景样式，有normal和emphasis两个属性</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].backgroundStyle.normal | Object</td>
...
<tr>
	<td align="center">series[0].backgroundStyle.emphasis | Object</td>
...
<tr>
	<td align="center">series[0].triangleStyle | Object</td>
	<td>导航项的三角标志样式，有normal和emphasis两个属性</td>
	<td></td>
</tr>
<tr>
	<td align="center">series[0].triangleStyle.normal | Object</td>
...
<tr>
	<td align="center">series[0].triangleStyle.emphasis | Object</td>
...
<tr>
	<td align="center">series[0].name | String</td>
	<td>导航栏绑定数据时的数据字段名称</td>
	<td></td>
</tr>
<tr>
	<td align="center">itemGap | Number</td>
	<td>导航项之间的间距</td>
	<td></td>
</tr>
</table>
