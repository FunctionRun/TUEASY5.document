...
| tableStyle.borderWidth | String | √ | 0 | 支持CSS3中width的参数值 | 表格边框宽度 |
...
| theadStyle.mouse | Object | √ |  |  | 表头**未选中**状态样式 |
| theadStyle.mouse.backgroundColor | String | √ | \#667688 | 支持CSS3中颜色的参数值，包括Color Name\(颜色名称\)、HEX、RGB、RGBA、HSL、HSLA、transparent | 表头**未选中**状态背景颜色 |
| theadStyle.mouse.color | String | √ | \#fff | 支持CSS3中颜色的参数值，包括Color Name\(颜色名称\)、HEX、RGB、RGBA、HSL、HSLA、transparent | 表头**未选中**状态文字颜色 |
